...
namespace pafap
{
    public partial class pafapSE : System.Web.UI.Page
    {
        ...
        public void LoadDataRepeater()
        {
            ...
            pafap_global.Init.InitSql.closeSqlConn();
        }
        //Next linkbutton;
        ...
        protected void lnkList_Click(object sender, EventArgs e)
        {
            ...
            lblstatus.Text = pafap_global.Init.InitFiles.errors;
        }
        ...
        protected void ReadLogFile(string lf)
        {
            /*StreamReader sr = new StreamReader(lf);
            lblogview.Text = sr.ReadToEnd();*/
        }
    }
}
